...
//this is other users
//users collection-> reciecer user id =>chats collection-> current user id-> set data
    if (isGroupChat) {
...
//below this is for own
//users collection-> current user id =>chats collection-> reciever user id-> set data
    ...
    try {
      ...
      switch (messageEnum) {
        case MessageEnum.image:
          contactMsg = 'Photo'; //usne icons lag rakhe h
          break;
